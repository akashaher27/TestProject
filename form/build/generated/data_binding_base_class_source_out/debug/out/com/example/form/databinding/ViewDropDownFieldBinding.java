...
public final class ViewDropDownFieldBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ViewDropDownFieldBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ViewDropDownFieldBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.view_drop_down_field, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
